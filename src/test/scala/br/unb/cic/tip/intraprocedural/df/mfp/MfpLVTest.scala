...
class MfpLVTest extends AnyFunSuite {
  ...
  /** x = a; Entry: {a, b} Exit: {b,x} y = b+1; Entry: {b, x} Exit: {x} output
    * x; Entry: {x} Exit: { }
    */
  ...
  /** if (x < y) { Entry: {a, x, y} Exit: {a} x = a; Entry: {a} Exit: { } } y =
    * 1; Entry: { } Exit: { }
    */
  ...
  /** x = 2; Entry: { } Exit: {} y = 4; Entry: { } Exit: {y} x = 1; Entry: {y}
    * Exit: {x, y} if (y < x) { Entry: {x, y} Exit: {y} z = y; Entry: {y} Exit:
    * {z} } else { z = y * y; Entry: {y} Exit: {z} } x = z; Entry: {z} Exit: {}
    */
  ...
  /** while(x < 10) { Entry: {x} Exit: {x} x = x+1; Entry: {x} Exit: {x} }
